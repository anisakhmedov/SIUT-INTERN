import{c as ae,r as s,j as e,S as pe,a as ue,g as Z,p as me,t as ge}from"./index-ulkMmI0r.js";import{C as J}from"./ui-SEvN8Z7c.js";import{X as G}from"./x-C3njciLt.js";import{C as xe}from"./calendar-BukBerVy.js";import{C as be,a as fe}from"./chevron-right-W5a4QpZG.js";const he=[["line",{x1:"2",x2:"5",y1:"12",y2:"12",key:"bvdh0s"}],["line",{x1:"19",x2:"22",y1:"12",y2:"12",key:"1tbv5k"}],["line",{x1:"12",x2:"12",y1:"2",y2:"5",key:"11lu5j"}],["line",{x1:"12",x2:"12",y1:"19",y2:"22",key:"x3vr5v"}],["circle",{cx:"12",cy:"12",r:"7",key:"fim9np"}],["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}]],ye=ae("locate-fixed",he);const ve=[["path",{d:"M18 8c0 3.613-3.869 7.429-5.393 8.795a1 1 0 0 1-1.214 0C9.87 15.429 6 11.613 6 8a6 6 0 0 1 12 0",key:"11u0oz"}],["circle",{cx:"12",cy:"8",r:"2",key:"1822b1"}],["path",{d:"M8.714 14h-3.71a1 1 0 0 0-.948.683l-2.004 6A1 1 0 0 0 3 22h18a1 1 0 0 0 .948-1.316l-2-6a1 1 0 0 0-.949-.684h-3.712",key:"q8zwxj"}]],we=ae("map-pinned",ve),je="a82d324e-b1dc-4510-b1f8-782e0913094e",ee=`https://api-maps.yandex.ru/2.1/?lang=en_US&apikey=${je}`,ke=[41.3775,69.1824];function te(r){return Array.isArray(r)?r:Array.isArray(r?.data)?r.data:Array.isArray(r?.users)?r.users:[]}function re(r){return{_id:r?._id||r?.id||r?.userId||"",name:r?.name||"",surname:r?.surname||"",lastname:r?.lastname||"",role:r?.role||"",login:r?.login||r?.email||"",phone:r?.phone||""}}function X(r){return[r?.name,r?.surname,r?.lastname].filter(Boolean).join(" ").trim()||"Unnamed tutor"}function B(r){const g=Number(Number(r[0]).toFixed(6)),x=Number(Number(r[1]).toFixed(6));return{label:`Selected point [${g}, ${x}]`,fullAddress:`Selected point [${g}, ${x}]`,street:"",city:"",country:"",coords:[g,x]}}function W(r){const g=r.getFullYear(),x=String(r.getMonth()+1).padStart(2,"0"),j=String(r.getDate()).padStart(2,"0");return`${g}-${x}-${j}`}function ne(r){if(!r)return new Date;const[g,x,j]=r.split("-").map(Number);return new Date(g,x-1,j)}function Ne({startDate:r,endDate:g,onChange:x,daysCount:j}){const[v,i]=s.useState(!1),[f,E]=s.useState(r?ne(r):new Date),[I,C]=s.useState("bottom"),k=s.useRef(null),y=s.useRef(null),D=s.useRef(null),M=l=>new Date(l.getFullYear(),l.getMonth()+1,0).getDate(),$=l=>new Date(l.getFullYear(),l.getMonth(),1).getDay(),S=l=>W(l),T=l=>{if(!r||!g)return!1;const m=S(l);return m>=r&&m<=g},L=l=>{const m=S(l);return m===r||m===g},F=l=>{const m=S(new Date(f.getFullYear(),f.getMonth(),l));if(!r||r&&g)x({startDate:m,endDate:""});else{const w=new Date(r+"T00:00:00");new Date(m+"T00:00:00")<w?x({startDate:m,endDate:r}):x({startDate:r,endDate:m}),i(!1)}},z=()=>{E(new Date(f.getFullYear(),f.getMonth()-1,1))},_=()=>{E(new Date(f.getFullYear(),f.getMonth()+1,1))},A=()=>{const l=M(f),m=$(f),w=[];for(let a=0;a<m;a++)w.push(e.jsx("div",{className:"cdrp-day-empty"},`empty-${a}`));for(let a=1;a<=l;a++){const d=new Date(f.getFullYear(),f.getMonth(),a),c=L(d),p=T(d);w.push(e.jsx("button",{type:"button",className:`cdrp-day ${c?"cdrp-day--selected":""} ${p?"cdrp-day--range":""}`,onClick:()=>F(a),children:a},a))}return w};return s.useEffect(()=>{const l=m=>{k.current&&!k.current.contains(m.target)&&i(!1)};if(v)return document.addEventListener("mousedown",l),()=>document.removeEventListener("mousedown",l)},[v]),s.useEffect(()=>{if(!v||!y.current||!D.current)return;const m=setTimeout(()=>{const w=y.current.getBoundingClientRect(),a=D.current.offsetHeight,c=window.innerHeight-w.bottom,p=w.top,b=20;c<a+b&&p>a+b?C("top"):C("bottom")},0);return()=>clearTimeout(m)},[v]),e.jsxs("div",{ref:k,className:"custom-date-range-picker",children:[e.jsx("style",{children:`
      ...
      `}),e.jsxs("div",{className:"cdrp-input-wrapper",children:[e.jsx(xe,{className:"cdrp-icon",size:14}),e.jsx("input",{ref:y,type:"text",className:"cdrp-input",value:r&&g?`${r} → ${g}`:r?`From ${r}`:"Select date range",placeholder:"Select date range",readOnly:!0,onClick:()=>i(!v)}),(r||g)&&e.jsx("button",{type:"button",className:"cdrp-clear-btn",onClick:()=>{x({startDate:"",endDate:""}),i(!1)},children:e.jsx(G,{size:14})})]}),v&&e.jsxs("div",{ref:D,className:"cdrp-popup","data-position":I,children:[e.jsxs("div",{className:"cdrp-header",children:[e.jsx("button",{type:"button",className:"cdrp-nav-btn",onClick:z,children:e.jsx(be,{size:14})}),e.jsx("span",{className:"cdrp-month-year",children:f.toLocaleString("en-US",{month:"long",year:"numeric"})}),e.jsx("button",{type:"button",className:"cdrp-nav-btn",onClick:_,children:e.jsx(fe,{size:14})})]}),e.jsx("div",{className:"cdrp-weekdays",children:["Sun","Mon","Tue","Wed","Thu","Fri","Sat"].map(l=>e.jsx("div",{className:"cdrp-weekday",children:l},l))}),e.jsx("div",{className:"cdrp-days",children:A()}),r&&g&&e.jsxs("div",{className:"cdrp-info",children:[e.jsxs("div",{className:"cdrp-range-text",children:[j," days ","selected"]}),e.jsxs("div",{children:[r," to ",g]})]})]})]})}function Se({value:r,onChange:g}){const x=s.useRef(null),j=s.useRef(null),v=s.useRef(null),i=s.useRef(null),f=s.useRef(g),E=s.useRef(r?.label||""),I=s.useRef(r?.coords||ke),C=s.useRef(r?.label||"Selected place"),[k,y]=s.useState(r?.label||""),[D,M]=s.useState(!1),[$,S]=s.useState(!1),[T,L]=s.useState([]),[F,z]=s.useState(""),_=s.useRef((a,d="")=>{const c=a?.properties?.get?.("metaDataProperty.GeocoderMetaData.Address.Components")||a?.properties?.get?.("metaDataProperty.GeocoderMetaData.Address.components")||[],p=a?.getAddressLine?.()||a?.properties?.get?.("metaDataProperty.GeocoderMetaData.text")||d||"Selected place",b=(...U)=>c.find(q=>U.includes(q.kind))?.name||"",N=[b("street"),b("house")].filter(Boolean).join(" "),P=b("locality","district","province"),R=b("country");return{label:p,fullAddress:p,street:N,city:P,country:R}}),A=s.useRef((a,d)=>{const c=[Number(Number(a[0]).toFixed(6)),Number(Number(a[1]).toFixed(6))],p=d||B(c);f.current({label:p.fullAddress||p.label||"Selected place",fullAddress:p.fullAddress||p.label||"Selected place",street:p.street||"",city:p.city||"",country:p.country||"",coords:c})});s.useEffect(()=>{f.current=g},[g]);const l=async a=>{if(!window.ymaps?.geocode)return null;const c=(await window.ymaps.geocode(a,{results:1,kind:"house"}))?.geoObjects?.get?.(0);return c?_.current(c,E.current):null};s.useEffect(()=>{E.current=k},[k]),s.useEffect(()=>{if(typeof window>"u")return;if(!ee){z("Map unavailable: VITE_YANDEX_MAPS_API_KEY is not set.");return}const a=document.querySelector('script[data-yandex-maps="true"]'),d=()=>{window.ymaps?.ready&&window.ymaps.ready(()=>M(!0))};if(window.ymaps){d();return}if(a)return a.addEventListener("load",d,{once:!0}),()=>a.removeEventListener("load",d);const c=document.createElement("script");return c.dataset.yandexMaps="true",c.async=!0,c.src=ee,c.onload=d,c.onerror=()=>z("Failed to load Yandex Maps."),document.head.appendChild(c),()=>{c.onload=null}},[]),s.useEffect(()=>{if(!D||!x.current||!window.ymaps||v.current)return;const a=new window.ymaps.Map(x.current,{center:I.current,zoom:13,controls:["zoomControl","fullscreenControl"]}),d=new window.ymaps.Placemark(I.current,{balloonContent:C.current},{preset:"islands#redDotIcon",draggable:!0});return a.geoObjects.add(d),a.events.add("click",c=>{const p=c.get("coords");d.geometry.setCoordinates(p),l(p).then(b=>{const N=b||B(p);A.current(p,N),y(N.fullAddress||N.label||"")}).catch(()=>{const b=B(p);A.current(p,b),y(b.fullAddress)})}),d.events.add("dragend",()=>{const c=d.geometry.getCoordinates();l(c).then(p=>{const b=p||B(c);A.current(c,b),y(b.fullAddress||b.label||"")}).catch(()=>{const p=B(c);A.current(c,p),y(p.fullAddress)})}),v.current=a,j.current=d,()=>{a.destroy(),v.current=null,j.current=null}},[D]),s.useEffect(()=>{!v.current||!j.current||r?.coords&&Array.isArray(r.coords)&&r.coords.length===2&&(v.current.setCenter(r.coords,v.current.getZoom(),{duration:250}),j.current.geometry.setCoordinates(r.coords))},[r?.coords]);const m=s.useCallback(async a=>{const d=a.trim();if(!d||!window.ymaps?.geocode){L([]);return}S(!0),z("");try{const b=((await window.ymaps.geocode(d,{results:15}))?.geoObjects?.toArray?.()||[]).map(N=>{const P=N.geometry.getCoordinates(),R=_.current(N,d);return{label:R.fullAddress,fullAddress:R.fullAddress,street:R.street,city:R.city,country:R.country,coords:[Number(P[0].toFixed(6)),Number(P[1].toFixed(6))]}});L(b)}catch{z("Could not search the place on Yandex Maps.")}finally{S(!1)}},[]);s.useEffect(()=>{if(k.trim())return i.current&&clearTimeout(i.current),i.current=setTimeout(()=>{m(k)},450),()=>{i.current&&clearTimeout(i.current)}},[k,m]);const w=a=>{y(a.label),L([]),A.current(a.coords,a)};return e.jsxs("div",{style:{marginTop:8},children:[e.jsxs("div",{style:{display:"grid",gap:10,marginBottom:10},children:[e.jsxs("div",{style:{position:"relative"},children:[e.jsx(we,{size:16,style:{position:"absolute",left:12,top:12,color:"var(--t3, #9ba3bb)"}}),e.jsx("input",{type:"text",className:"form-input",value:k,onChange:a=>y(a.target.value),placeholder:"Type a place name, street, or city",style:{paddingLeft:38}})]}),e.jsxs("button",{type:"button",className:"btn btn-secondary",onClick:()=>m(k),disabled:$,children:[e.jsx(ye,{size:14})," ",$?"Searching...":"Search on Yandex Maps"]})]}),F&&e.jsx("div",{style:{background:"rgba(239,68,68,.1)",color:"#b91c1c",padding:"10px 12px",borderRadius:10,marginBottom:10,fontSize:12},children:F}),e.jsx("div",{ref:x,style:{width:"100%",height:320,borderRadius:16,overflow:"hidden",border:"1px solid rgba(0,0,0,.1)",background:"rgba(0,0,0,.04)"}}),e.jsx("div",{style:{marginTop:10,fontSize:12,color:"var(--t2, #5a6278)",lineHeight:1.5},children:r?.label?e.jsxs("div",{style:{display:"grid",gap:4},children:[e.jsxs("div",{children:["Selected place: ",e.jsx("strong",{style:{color:"var(--t1, #0c0e18)"},children:r.fullAddress||r.label})]}),e.jsxs("div",{children:["Coordinates: ",e.jsxs("strong",{style:{color:"var(--t1, #0c0e18)"},children:["[",r.coords?.[0],", ",r.coords?.[1],"]"]})]}),(r.street||r.city||r.country)&&e.jsxs("div",{children:[r.street?e.jsxs("span",{children:[e.jsx("strong",{children:"Street:"})," ",r.street]}):null,r.city?e.jsxs("span",{children:[r.street?" | ":"",e.jsx("strong",{children:"City:"})," ",r.city]}):null,r.country?e.jsxs("span",{children:[r.street||r.city?" | ":"",e.jsx("strong",{children:"Country:"})," ",r.country]}):null]})]}):"Select a point on the map or search for a place. The form will save coordinates as [lat, lng] and a full address."}),T.length>0&&e.jsxs("div",{style:{marginTop:10,display:"grid",gap:8},children:[e.jsx("div",{style:{fontSize:11,color:"var(--t3, #9ba3bb)",fontWeight:600},children:"Similar results"}),T.map(a=>e.jsxs("button",{type:"button",onClick:()=>w(a),style:{textAlign:"left",borderRadius:12,padding:"10px 12px",border:"1px solid rgba(0,0,0,.08)",background:"rgba(255,255,255,.92)",cursor:"pointer",fontSize:12,color:"var(--t1, #0c0e18)"},children:[e.jsx("div",{style:{fontWeight:700,marginBottom:2},children:a.label}),e.jsx("div",{style:{color:"var(--t2, #5a6278)"},children:a.street||a.city||a.country?[a.street,a.city,a.country].filter(Boolean).join(", "):"Address unavailable"}),e.jsxs("div",{style:{color:"var(--t2, #5a6278)",marginTop:2},children:["[",a.coords[0],", ",a.coords[1],"]"]})]},`${a.label}-${a.coords.join(",")}`))]})]})}function Ee({onSubmit:r,onCancel:g,students:x=[],tutors:j=[],user:v=null}){const[i,f]=s.useState({name:"",company:"",location:"",locationYmaps:null,duration:{start:"",end:""},status:"Pending",plan:"",days:[]}),[E,I]=s.useState(()=>{try{return Array.isArray(x)?x.map(t=>({_id:t._id||t.id||t.studentId||String(Math.random()),name:t.name||t.fullName||"",surname:t.surname||"",lastname:t.lastname||"",nameFaculty:t.nameFaculty||t.faculty||t.facultyName||"",studentId:t.studentId||t.id||""})):[]}catch{return[]}}),[C,k]=s.useState([]),[y,D]=s.useState(""),[M,$]=s.useState(""),[S,T]=s.useState([]),[L,F]=s.useState([]),[z,_]=s.useState(!1),[A,l]=s.useState(!1),m=s.useRef(null),w=s.useMemo(()=>te(j).map(re).filter(t=>{const o=String(t.role||"").trim().toLowerCase();return o==="tutor"||o==="professor"}),[j]),a=w.length>0?w:L,d=s.useMemo(()=>S.map(t=>a.find(o=>o._id===t)).filter(Boolean),[S,a]);s.useEffect(()=>{if(w.length>0){F(w);return}if(!(String(v?.role||"").toLowerCase()==="admin")){F([]);return}(async()=>{try{_(!0);const n=await Z("/usersInternship"),h=te(n).map(re).filter(u=>{const Y=String(u.role||"").trim().toLowerCase();return Y==="tutor"||Y==="professor"});F(h)}catch(n){console.error("Error fetching tutors:",n)}finally{_(!1)}})()},[w,v?.role]),s.useEffect(()=>{T(t=>t.filter(o=>a.some(n=>n._id===o)))},[a]),s.useEffect(()=>{const t=n=>{m.current&&!m.current.contains(n.target)&&l(!1)},o=n=>{n.key==="Escape"&&l(!1)};return document.addEventListener("mousedown",t),document.addEventListener("keydown",o),()=>{document.removeEventListener("mousedown",t),document.removeEventListener("keydown",o)}},[]),s.useEffect(()=>{if(Array.isArray(x)&&x.length>0){I(x.map(n=>({_id:n._id||n.id||n.studentId||String(Math.random()),name:n.name||n.fullName||"",surname:n.surname||"",lastname:n.lastname||"",nameFaculty:n.nameFaculty||n.faculty||n.facultyName||"",studentId:n.studentId||n.id||""})));return}let t=!0;return(async()=>{try{const n=await Z("/student"),h=Array.isArray(n)?n:Array.isArray(n?.data)?n.data:Array.isArray(n?.students)?n.students:[];if(!t)return;I(h.map(u=>({_id:u._id||u.id||u.studentId||String(Math.random()),name:u.name||u.fullName||"",surname:u.surname||"",lastname:u.lastname||"",nameFaculty:u.nameFaculty||u.faculty||u.facultyName||"",studentId:u.studentId||u.id||""})))}catch(n){console.error("Error fetching students for CreatePage:",n)}})(),()=>{t=!1}},[x]);const c=[...new Set(E.map(t=>t.nameFaculty).filter(Boolean))],b=E.filter(t=>t.name&&t.name.toLowerCase().includes(y.toLowerCase())||t.surname&&t.surname.toLowerCase().includes(y.toLowerCase())||t.lastname&&t.lastname.toLowerCase().includes(y.toLowerCase())||t.nameFaculty&&t.nameFaculty.toLowerCase().includes(y.toLowerCase())).filter(t=>!M||t.nameFaculty===M).filter(t=>!C.some(o=>(o._id||o.id)===(t._id||t.id))),N=t=>{const{name:o,value:n}=t.target;f(h=>({...h,[o]:n}))},P=()=>{if(!i.duration?.start||!i.duration?.end)return 0;const t=new Date(i.duration.start),n=new Date(i.duration.end)-t,h=Math.ceil(n/(1e3*60*60*24))+1;return Math.max(0,h)},R=()=>{if(!i.duration?.start||!i.duration?.end)return[];const t=P(),o=[],n=ne(i.duration.start);for(let h=0;h<t;h++){const u=new Date(n);u.setDate(u.getDate()+h);const Y=W(u);o.push({dayNumber:String(h+1),date:Y,approved:1,shortReport:null,comments:[],images:[]})}return o},U=(t,o)=>{if(!t||!o)return"";const n=new Date(t),u=new Date(o)-n;return`${Math.ceil(u/(1e3*60*60*24))+1} days (${t} to ${o})`},K=()=>{const t=i.duration?.start,o=i.duration?.end;return!t||!o?"":U(t,o)},q=async t=>{t.preventDefault();try{if(!Array.isArray(i.locationYmaps?.coords)||i.locationYmaps.coords.length!==2)throw new Error("Please choose a location on the Yandex map.");if(!i.duration?.start||!i.duration?.end)throw new Error("Please select both start and end dates.");const o=R();if(o.length===0)throw new Error("Invalid date range. End date must be after start date.");const n={...i,tutorID:S[0]||"",tutorIDs:S,location:i.locationYmaps?.label||i.location,locationYmaps:i.locationYmaps.coords,duration:{start:i.duration.start,end:i.duration.end},days:o,numberOfStudents:C.map(u=>({_id:u._id,name:u.name,surname:u.surname,lastname:u.lastname,nameFaculty:u.nameFaculty}))},h=await me("/faculty",n);r(h)}catch(o){ge.error(o.message||"Failed to create internship."),console.error("Error creating internship:",o)}},oe=t=>{T(o=>o.includes(t)?o.filter(n=>n!==t):[...o,t])},se=t=>{T(o=>o.filter(n=>n!==t))},ie=t=>{k(o=>[...o,t]),D("")},ce=s.useMemo(()=>{const t=i.locationYmaps;return t?.label&&Array.isArray(t?.coords)&&t.coords.length===2?t:null},[i.locationYmaps]),le=t=>{k(o=>o.filter(n=>n._id!==t))};return e.jsxs("div",{className:"create-page",children:[e.jsx("style",{children:`
        .create-page {
