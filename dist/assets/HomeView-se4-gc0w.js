import{c as ae,r as f,g as oe,t as J,j as e,P as Q,u as G,d as ke,U as Se,M as ze,T as Ce,v as Me}from"./index-ulkMmI0r.js";import{h as he}from"./reportUtils-Cg4yPpzq.js";import{R as F}from"./Reveal-B8CcOqmA.js";import{U as Ie}from"./user-BeEqMeGu.js";import{C as Ae}from"./calendar-BukBerVy.js";import{C as De}from"./clock-Bt9h_YP2.js";import{P as Le}from"./phone-BAlgemXl.js";import{a as le,C as $e}from"./chevron-right-W5a4QpZG.js";const Pe=[["path",{d:"M5 21v-6",key:"1hz6c0"}],["path",{d:"M12 21V3",key:"1lcnhd"}],["path",{d:"M19 21V9",key:"unv183"}]],Te=ae("chart-no-axes-column",Pe);const Fe=[["path",{d:"M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 16 0",key:"1r0f0z"}],["circle",{cx:"12",cy:"10",r:"3",key:"ilqhr7"}]],We=ae("map-pin",Fe);const Re=[["path",{d:"M11.525 2.295a.53.53 0 0 1 .95 0l2.31 4.679a2.123 2.123 0 0 0 1.595 1.16l5.166.756a.53.53 0 0 1 .294.904l-3.736 3.638a2.123 2.123 0 0 0-.611 1.878l.882 5.14a.53.53 0 0 1-.771.56l-4.618-2.428a2.122 2.122 0 0 0-1.973 0L6.396 21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.122 2.122 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.122 2.122 0 0 0 1.597-1.16z",key:"r04s7s"}]],Be=ae("star",Re),ee=a=>Math.max(0,Math.min(100,Number.isFinite(a)?a:0)),Ee=a=>{const t=Array.isArray(a)?a:[];if(t.length===0)return null;const l=t.filter(d=>he(d)).length;return ee(Math.round(l/t.length*100))},Ue=a=>{if(typeof a=="number"&&Number.isFinite(a))return ee(Math.round(a));if(typeof a=="string"){const t=Number.parseFloat(a.replace("%","").trim());if(Number.isFinite(t))return ee(Math.round(t))}return null},de=a=>{const t=a?.duration;if(t&&typeof t=="object")return{start:t.start||t.startDate||a?.startDate||"",end:t.end||t.endDate||a?.endDate||"",durationText:""};const l=typeof t=="string"?t.trim():"";if(a?.startDate||a?.endDate)return{start:a?.startDate||"",end:a?.endDate||"",durationText:l};if(l){const d=l.match(/\b\d{4}-\d{2}-\d{2}\b|\b\d{1,2}\.\d{1,2}\.\d{4}\b/g);if(d&&d.length>=2)return{start:d[0],end:d[1],durationText:l}}return{start:"",end:"",durationText:l}},re=a=>{if(!a)return null;if(a instanceof Date)return Number.isNaN(a.getTime())?null:a;if(typeof a=="number"){const x=new Date(a);return Number.isNaN(x.getTime())?null:x}const t=String(a).trim();if(!t)return null;const l=t.match(/^(\d{4})-(\d{2})-(\d{2})$/);if(l){const[,x,m,y]=l,w=new Date(Number(x),Number(m)-1,Number(y));return Number.isNaN(w.getTime())?null:w}const d=t.match(/^(\d{1,2})\.(\d{1,2})\.(\d{4})$/);if(d){const[,x,m,y]=d,w=new Date(Number(y),Number(m)-1,Number(x));return Number.isNaN(w.getTime())?null:w}const g=new Date(t);return Number.isNaN(g.getTime())?null:g},ce=a=>{const t=re(a);if(!t)return"";const l=String(t.getDate()).padStart(2,"0"),d=String(t.getMonth()+1).padStart(2,"0"),g=t.getFullYear();return`${l}.${d}.${g}`};function _e({onNewFaculty:a,onView:t,search:l="",user:d=null}){const[g,x]=f.useState([]),[m,y]=f.useState({}),[w,j]=f.useState(!0),[N,b]=f.useState(""),[M,P]=f.useState("all"),z=6,[I,E]=f.useState({inProgress:1,completed:1,notStarted:1}),U=()=>E({inProgress:1,completed:1,notStarted:1}),W=r=>r?._id??r?.id??null,T=r=>String(r||"").trim().toLowerCase(),i=r=>Array.isArray(r)?r.flatMap(i):r?[r]:[],u=r=>{if(!r)return[];if(typeof r=="string"){const s=r.trim();return s?[s]:[]}return[r._id,r.id,r.userId,r.login,r.email].filter(Boolean)},S=r=>{if(!r)return"";if(typeof r=="string"){const n=m[r];if(n){const o=[n.name,n.surname,n.lastname].filter(Boolean).join(" ").trim();if(o)return o;if(n.login)return n.login}return r.trim()}const s=[r.name,r.surname,r.lastname].filter(Boolean).join(" ").trim();return s||(r.login?r.login:r.email?r.email:r._id?String(r._id):r.id?String(r.id):"")},A=r=>{const s=[],n=new Set;return[r?.tutorIDs,r?.tutors,r?.tutorID,r?.tutor,r?.supervisor].flatMap(i).forEach(o=>{const c=T(typeof o=="string"?o:o?._id||o?.id||o?.userId||o?.login||o?.email);!c||n.has(c)||(n.add(c),s.push(o))}),s},L=r=>{const s=new Set;return A(r).forEach(n=>{u(n).forEach(o=>{const c=T(o);c&&s.add(c)})}),Array.from(s)},C=r=>{const s=[],n=new Set;return A(r).forEach(o=>{const c=S(o).trim(),p=T(c);!c||n.has(p)||(n.add(p),s.push(c))}),s},_=r=>{const s=C(r);if(s.length>0)return s.join(", ");const n=[r?.tutorName,r?.supervisorName].filter(Boolean).join(" ").trim();return n||"Not assigned"},Z=r=>{const s=A(r)[0];return s&&typeof s=="object"?s:typeof s=="string"&&s.trim()&&m[s]||null},V=r=>{const s=Z(r);return s?s.phone||s.email||s.login||"N/A":r?.tutorContact||r?.supervisorContact||"N/A"},Y=r=>{const n=C(r)[0]||_(r);return!n||n==="Not assigned"?"U":n.split(" ").filter(Boolean).slice(0,2).map(o=>o[0]?.toUpperCase()).join("")||"U"},D=r=>{const{start:s,end:n,durationText:o}=de(r),c=ce(s),p=ce(n);return c&&p?`${c} - ${p}`:c||p?c||p:o||"N/A"},ue=r=>{const{start:s,end:n,durationText:o}=de(r),c=re(s),p=re(n);if(!c||!p)return o||"N/A";const k=p.getTime()-c.getTime(),v=Math.max(0,Math.ceil(k/(1e3*60*60*24))+1);return`${v} day${v===1?"":"s"}`},se=r=>{const s=r?.locationYmaps,n=Array.isArray(s)?s:Array.isArray(s?.coords)?s.coords:null;if(Array.isArray(n)&&n.length===2){const c=Number(n[0]),p=Number(n[1]);if(!Number.isNaN(c)&&!Number.isNaN(p))return`https://yandex.com/maps/?pt=${p},${c}&z=15&l=map`}const o=(r?.location||"").trim();return o?`https://yandex.com/maps/?text=${encodeURIComponent(o)}`:null},R=r=>{const s=Ee(r?.days);if(s!=null)return s;const n=Ue(r?.progressAll);return n??0},ne=N||l,O=g.filter((r,s)=>{if(String(d?.role||"").trim().toLowerCase()==="tutor"){const o=[d?._id,d?.id,d?.userId,d?.login,d?.email].map(p=>T(p)).filter(Boolean),c=L(r);if(s===0&&console.log("[Dashboard] Tutor filter debug:",{userIds:o,facultyTutorIds:c,hasMatch:o.some(p=>c.includes(p)),tutors:A(r)}),!o.some(p=>c.includes(p)))return!1}if(ne){const o=ne.toLowerCase();if(!(r.name?.toLowerCase().includes(o)||r.company?.toLowerCase().includes(o)||r.location?.toLowerCase().includes(o)||r.plan?.toLowerCase().includes(o)))return!1}if(M!=="all"){const o=R(r);if(M==="not-started"&&o!==0||M==="in-progress"&&(o<1||o>99)||M==="completed"&&o!==100)return!1}return!0}),we=O.filter(r=>R(r)===0),ve=O.filter(r=>{const s=R(r);return s>=1&&s<=99}),ye=O.filter(r=>R(r)===100),ie=f.useCallback(async()=>{try{j(!0);const r=String(d?.role||"").toLowerCase()==="admin",[s,n]=await Promise.allSettled([oe("/faculty"),r?oe("/usersInternship"):Promise.resolve([])]);if(s.status==="fulfilled")x(Array.isArray(s.value)?s.value:[]);else throw s.reason;if(n.status==="fulfilled"){const o=n.value,p=(Array.isArray(o)?o:o?.data||[]).reduce((k,v)=>{const $=String(v?._id??v?.id??"");return $&&(k[$]=v),k},{});y(p)}else y({})}catch(r){J.error(r?.message||"Failed to load internships."),console.error("Error fetching faculties:",r)}finally{j(!1)}},[d?.role]);f.useEffect(()=>{ie()},[ie]);const je=async r=>{if(window.confirm("Are you sure you want to delete this internship?"))try{await ke(`/faculty/${r}`),x(s=>s.filter(n=>String(W(n))!==String(r))),J.success("Internship deleted.")}catch(s){J.error("Failed to delete internship."),console.error("Delete error:",s)}},Ne=(r,s)=>{const n=W(r)??`row-${s}`,o=R(r),c=Math.round(o/100*120),p=G(r.status),k=C(r),v=k.length>1,$=v?`${k.length} tutors appended`:_(r),q=p==="Pending"?"dw-card-badge--pending":p==="In Progress"?"dw-card-badge--progress":"dw-card-badge--completed";return e.jsx("li",{children:e.jsxs("article",{className:"dw-card",children:[e.jsx("div",{role:"button",tabIndex:0,className:"dw-card-click",onClick:()=>{n&&t(n)},onKeyDown:h=>{(h.key==="Enter"||h.key===" ")&&(h.preventDefault(),n&&t(n))},children:e.jsxs("div",{className:"dw-card-body",children:[e.jsx("h3",{className:"dw-card-title",children:r.name}),p&&e.jsx("span",{className:`dw-card-badge ${q}`,children:p}),e.jsxs("div",{className:"dw-card-meta",children:[e.jsx("span",{children:r.company||"No company"}),p&&e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"dw-card-meta-divider"}),e.jsx("span",{children:p})]})]}),e.jsxs("div",{className:"dw-card-row",children:["Who:",v?e.jsx("strong",{style:{display:"block",marginTop:"4px"},children:$}):e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"8px",marginTop:"4px"},children:[e.jsx("div",{style:{width:28,height:28,borderRadius:6,background:"linear-gradient(135deg,#635bff,#06c9a0)",display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"Syne",fontWeight:700,color:"#fff",fontSize:11,flexShrink:0},children:Y(r)}),e.jsx("strong",{children:$})]})]}),e.jsxs("div",{className:"dw-card-row",children:["Where:",se(r)&&e.jsx("a",{href:se(r),target:"_blank",rel:"noreferrer",className:"dw-map-link",onClick:h=>h.stopPropagation(),children:"Link"})]}),e.jsxs("div",{className:"dw-card-row",children:[e.jsx("span",{children:"When:"})," ",e.jsx("strong",{children:D(r)})]}),e.jsxs("div",{className:"dw-card-row",children:[e.jsx("span",{children:"How long:"})," ",e.jsx("strong",{children:ue(r)})]}),e.jsxs("div",{className:"dw-card-row",children:["Contact: ",e.jsx("strong",{children:V(r)})]}),e.jsxs("div",{className:"dw-progress","aria-label":`Progress ${o}%`,children:[e.jsxs("div",{className:"dw-progress-top",children:[e.jsx("span",{className:"dw-progress-label",children:"Progress:"}),e.jsxs("span",{className:"dw-progress-value",style:{color:`hsl(${c} 76% 30%)`,borderColor:`hsla(${c}, 75%, 45%, .35)`,background:`linear-gradient(135deg, hsla(${Math.max(0,c-25)}, 95%, 92%, .95), hsla(${Math.min(120,c+20)}, 95%, 88%, .95))`},children:[o,"%"]})]}),e.jsx("div",{className:"dw-progress-track",children:e.jsx("div",{className:"dw-progress-fill",style:{width:`${o}%`,background:`linear-gradient(90deg, hsl(${Math.max(0,c-24)} 82% 56%), hsl(${Math.min(120,c+12)} 80% 44%))`}})})]})]})}),e.jsxs("div",{className:"dw-card-footer",children:[e.jsx("button",{type:"button",className:"dw-card-open",onClick:()=>{n&&t(n)},children:"View Details"}),["admin","developer"].includes(String(d?.role||"").toLowerCase())&&e.jsx("button",{type:"button",className:"dw-btn-icon",onClick:h=>{h.preventDefault(),h.stopPropagation(),n&&je(n)},title:"Delete internship","aria-label":"Delete internship",children:"×"})]})]})},n)},K=(r,s,n,o,c)=>{if(s.length===0)return null;const p=I[c]||1,k=Math.max(1,Math.ceil(s.length/z)),v=Math.min(p,k),$=s.slice((v-1)*z,v*z),q=h=>E(H=>({...H,[c]:typeof h=="function"?h(H[c]||1):h}));return e.jsxs("section",{className:"dw-section",children:[e.jsxs("div",{className:"dw-section-header",style:{"--sec-color":n},children:[e.jsx("div",{className:"dw-section-icon-wrap",style:{background:`${n}18`},children:e.jsx("svg",{width:"16",height:"16",viewBox:"0 0 16 16",fill:"none",children:e.jsx("path",{d:o,fill:n})})}),e.jsx("span",{className:"dw-section-title",children:r}),e.jsx("span",{className:"dw-section-badge",style:{background:`${n}18`,color:n},children:s.length})]}),e.jsx("ul",{className:"dw-list","aria-label":`${r} internships`,children:$.map((h,H)=>Ne(h,H))}),k>1&&e.jsxs("div",{className:"dw-sec-pag",children:[e.jsx("button",{className:"dw-sec-pag-btn",onClick:()=>q(h=>Math.max(1,h-1)),disabled:v===1,children:"← Prev"}),e.jsxs("span",{className:"dw-sec-pag-info",children:[v," / ",k]}),e.jsx("button",{className:"dw-sec-pag-btn",onClick:()=>q(h=>Math.min(k,h+1)),disabled:v===k,children:"Next →"})]})]},r)};return e.jsxs("div",{className:"dw-page",children:[e.jsx("style",{children:`
      ...
      `}),e.jsx(F,{children:e.jsxs("div",{style:{marginBottom:18},children:[e.jsxs("div",{style:{fontFamily:"Montserrat",fontSize:20,fontWeight:800,color:"var(--t1)",marginBottom:3},children:["ПОКА ЧТО НА РАЗРАБОТКЕ, ",d?.name||"User"]}),e.jsx("div",{style:{fontSize:13,color:"var(--t3)"},children:new Date().toLocaleDateString("en-US",{weekday:"long",month:"long",day:"numeric"})})]})}),e.jsx(F,{delay:50,children:e.jsx("div",{className:"gc",style:{display:"grid",gridTemplateColumns:"repeat(4,1fr)",marginBottom:20,padding:"14px 0"},children:T.map((i,u)=>e.jsxs("div",{style:{padding:"2px 20px",borderLeft:u>0?"1px solid var(--br)":"none"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:5,marginBottom:5},children:[e.jsx(i.I,{size:11,color:i.color}),e.jsx("span",{style:{fontSize:10,color:"var(--t3)",fontWeight:600,textTransform:"uppercase",letterSpacing:"0.05em"},children:i.label})]}),e.jsx("div",{style:{fontFamily:"Montserrat",fontSize:26,fontWeight:800,color:"var(--t1)",lineHeight:1},children:i.disp!=null?i.disp:e.jsx(Ve,{target:i.v,sfx:i.sfx})})]},i.label))})}),e.jsx(F,{delay:90,children:e.jsx("div",{className:"ov-filters",children:e.jsxs("div",{className:"ov-filter-bar",children:[e.jsxs("div",{className:"ov-search-wrap",children:[e.jsxs("svg",{className:"ov-search-icon",viewBox:"0 0 20 20",fill:"none",children:[e.jsx("circle",{cx:"9",cy:"9",r:"6",stroke:"currentColor",strokeWidth:"1.8"}),e.jsx("path",{d:"M13.5 13.5L17 17",stroke:"currentColor",strokeWidth:"1.8",strokeLinecap:"round"})]}),e.jsx("input",{className:"ov-search-input",type:"text",placeholder:"Search internships...",value:g,onChange:i=>W(i.target.value)}),g&&e.jsx("button",{className:"ov-search-clear",onClick:()=>W(""),"aria-label":"Clear search",children:e.jsx("svg",{width:"13",height:"13",viewBox:"0 0 14 14",fill:"none",children:e.jsx("path",{d:"M2 2l10 10M12 2L2 12",stroke:"currentColor",strokeWidth:"1.8",strokeLinecap:"round"})})})]}),e.jsx("div",{className:"ov-pills",children:Ke.map(({value:i,label:u,activeClass:S})=>{const L=m===i?`ov-pill ov-pill--${S.replace("dw-status-pill--active-","")}`:"ov-pill";return e.jsx("button",{type:"button",className:L,onClick:()=>U(i),children:u},i)})})]})})}),e.jsx(F,{delay:120,children:e.jsxs("div",{style:{fontFamily:"Montserrat",fontSize:14,fontWeight:700,color:"var(--t1)",marginBottom:14},children:["Internships",e.jsx("span",{style:{marginLeft:8,fontSize:12,fontWeight:500,color:"var(--t3)"},children:P.length})]})}),P.length===0?e.jsx(F,{delay:130,children:e.jsx("div",{className:"gc",style:{padding:40,textAlign:"center",color:"var(--t3)",fontSize:13},children:b===0?"No internships yet.":"No internships match your filters."})}):e.jsxs(e.Fragment,{children:[e.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(270px,1fr))",gap:12},children:E.map((i,u)=>{const S=G(i.status),A=xe[S]||xe.Pending,L=Ye(i),C=Math.round(L/100*120),_=me(i),Z=Ge(i),V=He(i),Y=Ze(i);return e.jsx(F,{delay:130+u*25,children:e.jsxs("div",{className:"gc",onClick:()=>l(i),style:{padding:0,cursor:"pointer",overflow:"hidden",display:"flex",flexDirection:"column",transition:"transform .15s, box-shadow .15s"},onMouseEnter:D=>{D.currentTarget.style.transform="translateY(-2px)",D.currentTarget.style.boxShadow="0 6px 20px rgba(0,0,0,.08)"},onMouseLeave:D=>{D.currentTarget.style.transform="",D.currentTarget.style.boxShadow=""},children:[e.jsxs("div",{style:{padding:"15px 16px 13px",flex:1},children:[e.jsxs("div",{style:{display:"flex",alignItems:"flex-start",justifyContent:"space-between",gap:8,marginBottom:4},children:[e.jsx("div",{style:{fontFamily:"Montserrat",fontSize:13,fontWeight:700,color:"var(--t1)",lineHeight:1.35,flex:1,minWidth:0},children:i.title}),e.jsxs("span",{style:{fontSize:10,fontWeight:700,padding:"3px 8px",borderRadius:6,background:A.bg,color:A.text,display:"flex",alignItems:"center",gap:4,flexShrink:0},children:[e.jsx("span",{style:{width:5,height:5,borderRadius:"50%",background:A.dot,display:"inline-block"}}),S]})]}),e.jsx("div",{style:{fontSize:12,color:"var(--t2)",marginBottom:13},children:i.company||"No company"}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:6,marginBottom:13},children:[e.jsx(B,{icon:e.jsx(Ie,{size:10,color:"var(--t3)"}),label:"Who",children:e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:5},children:[e.jsx("div",{style:{width:18,height:18,borderRadius:4,background:"var(--a1,#635bff)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:8,fontWeight:700,color:"#fff",flexShrink:0},children:Z}),e.jsx("span",{style:{fontSize:11,color:"var(--t1)",fontWeight:600,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:_})]})}),e.jsx(B,{icon:e.jsx(We,{size:10,color:"var(--t3)"}),label:"Where",children:Y?e.jsx("a",{href:Y,target:"_blank",rel:"noreferrer",onClick:D=>D.stopPropagation(),style:{fontSize:11,color:"var(--a1,#635bff)",fontWeight:600,textDecoration:"none"},children:"Map link"}):e.jsx("span",{style:{fontSize:11,color:"var(--t3)"},children:"N/A"})}),e.jsx(B,{icon:e.jsx(Ae,{size:10,color:"var(--t3)"}),label:"When",children:e.jsx("span",{style:{fontSize:11,color:"var(--t1)",fontWeight:500},children:qe(i)})}),e.jsx(B,{icon:e.jsx(De,{size:10,color:"var(--t3)"}),label:"Duration",children:e.jsx("span",{style:{fontSize:11,color:"var(--t1)",fontWeight:500},children:Oe(i)})}),V&&e.jsx(B,{icon:e.jsx(Le,{size:10,color:"var(--t3)"}),label:"Contact",children:e.jsx("span",{style:{fontSize:11,color:"var(--t1)",fontWeight:500},children:V})})]}),e.jsxs("div",{children:[e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",marginBottom:5},children:[e.jsx("span",{style:{fontSize:11,color:"var(--t3)"},children:"Progress"}),e.jsxs("span",{style:{fontSize:10,fontWeight:700,padding:"2px 7px",borderRadius:6,color:`hsl(${C} 76% 30%)`,background:`linear-gradient(135deg,hsla(${Math.max(0,C-25)},95%,92%,.95),hsla(${Math.min(120,C+20)},95%,88%,.95))`,border:`1px solid hsla(${C},75%,45%,.2)`},children:[L,"%"]})]}),e.jsx("div",{style:{height:5,background:"var(--br)",borderRadius:999,overflow:"hidden"},children:e.jsx("div",{style:{width:`${L}%`,height:"100%",borderRadius:999,background:`linear-gradient(90deg,hsl(${Math.max(0,C-24)} 82% 56%),hsl(${Math.min(120,C+12)} 80% 44%))`,transition:"width 1s ease"}})})]})]}),e.jsx("div",{style:{padding:"9px 16px",borderTop:"1px solid var(--br)",display:"flex",justifyContent:"flex-end"},children:e.jsxs("span",{style:{fontSize:11,color:"var(--t3)",fontWeight:600,display:"flex",alignItems:"center",gap:3},children:["View Details ",e.jsx(le,{size:11})]})})]})},i.id)})}),z>1&&e.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",gap:10,marginTop:18},children:[e.jsxs("button",{className:"bg",onClick:()=>j(i=>Math.max(1,i-1)),disabled:I===1,style:{display:"flex",alignItems:"center",gap:4,opacity:I===1?.4:1},children:[e.jsx($e,{size:12})," Prev"]}),e.jsxs("span",{style:{fontSize:12,color:"var(--t2)",fontWeight:500},children:[I," / ",z]}),e.jsxs("button",{className:"bg",onClick:()=>j(i=>Math.min(z,i+1)),disabled:I===z,style:{display:"flex",alignItems:"center",gap:4,opacity:I===z?.4:1},children:["Next ",e.jsx(le,{size:12})]})]})]})]})}function B({icon:a,label:t,children:l}){return e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:6},children:[a,e.jsx("span",{style:{fontSize:10,color:"var(--t3)",width:44,flexShrink:0},children:t}),e.jsx("div",{style:{flex:1,minWidth:0},children:l})]})}const be="siut_home_view";function Qe(){try{return localStorage.getItem(be)||"list"}catch{return"list"}}function Xe(a){try{localStorage.setItem(be,a)}catch{}}const fe=a=>["admin","developer"].includes(String(a?.role||"").toLowerCase());function lr({internships:a,feedbacks:t,user:l,students:d,search:g,onNewFaculty:x,onView:m}){const y=fe(l),[w,j]=f.useState(()=>{const b=Qe();return b==="overview"&&!fe(l)?"list":b}),N=b=>{j(b),Xe(b)};return e.jsxs(e.Fragment,{children:[y&&e.jsxs("div",{style:{display:"flex",justifyContent:"flex-end",gap:6,padding:"12px 20px 0"},children:[e.jsxs("button",{className:w==="list"?"bp":"bg",onClick:()=>N("list"),style:{display:"flex",alignItems:"center",gap:5,fontSize:12,padding:"6px 12px"},children:[e.jsx(Me,{size:13}),"Internships"]}),e.jsxs("button",{className:w==="overview"?"bp":"bg",onClick:()=>N("overview"),style:{display:"flex",alignItems:"center",gap:5,fontSize:12,padding:"6px 12px"},children:[e.jsx(Te,{size:13}),"Overview"]})]}),w==="list"||!y?e.jsx(_e,{onNewFaculty:x,onView:m,user:l,students:d,search:g}):e.jsx(Je,{internships:a,feedbacks:t,onOpen:b=>m(b.id),user:l})]})}export{lr as default};
