import{r as a,j as e,R as n}from"./index-B9wUb5OY.js";function o(){a.useEffect(()=>{document.title="Under Maintenance — SIUT";const t=document.querySelector('meta[name="robots"]');return t&&t.setAttribute("content","noindex, nofollow"),()=>{document.title="SIUT — Internship Portal"}},[]);const i={border:"none",borderRadius:14,padding:"12px 18px",fontFamily:"Montserrat, sans-serif",fontSize:14,fontWeight:700,cursor:"pointer",display:"inline-flex",alignItems:"center",justifyContent:"center",gap:8,transition:"transform .18s ease, box-shadow .18s ease, opacity .18s ease"};return e.jsxs("div",{className:"maint-root",style:{color:"#fff",overflow:"hidden"},children:[e.jsx("style",{children:`
        .maint-root{
      ...
      `}),e.jsxs("div",{className:"maint-card",children:[e.jsx("div",{style:{position:"absolute",inset:"-90px auto auto -90px",width:240,height:240,borderRadius:"50%",background:"rgba(99,91,255,.20)",filter:"blur(74px)",pointerEvents:"none"}}),e.jsx("div",{style:{position:"absolute",inset:"auto -70px -70px auto",width:220,height:220,borderRadius:"50%",background:"rgba(6,201,160,.16)",filter:"blur(70px)",pointerEvents:"none"}}),e.jsx("div",{className:"maint-grid",style:{position:"relative",zIndex:1},children:e.jsxs("div",{className:"maint-left",children:[e.jsx("div",{style:{display:"inline-flex",alignItems:"center",gap:10,color:"rgba(255,255,255,.88)",fontSize:12,fontWeight:700,letterSpacing:".08em",textTransform:"uppercase"},children:e.jsx("span",{className:"maint-badge",children:"Site under development"})}),e.jsxs("div",{style:{marginTop:15},children:[e.jsx("div",{className:"maint-code",children:"503"}),e.jsx("h1",{className:"maint-title",children:"The site is temporarily closed for maintenance"}),e.jsx("p",{className:"maint-desc",children:"The portal is in development mode. Regular users cannot open pages until maintenance is turned off."})]}),e.jsx("div",{className:"maint-actions",children:e.jsxs("button",{type:"button",onClick:()=>window.location.reload(),className:"maint-btn",style:{...i,background:"linear-gradient(135deg, #635bff, #06c9a0)",color:"#fff",boxShadow:"0 14px 34px rgba(99,91,255,.24)"},children:[e.jsx(n,{size:16}),"Check again"]})})]})})]}),e.jsx("div",{className:"maint-blob left"})]})}export{o as default};
